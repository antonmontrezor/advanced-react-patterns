...
The whole ided of a State Reducer is to create a wrapper reducer that wrapps the call to the default reducer and a user customize what state needs/doesn't need to be changed. Check notes
